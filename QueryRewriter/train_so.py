...
class T5FineTuner(pl.LightningModule):
    ...
    def train_dataloader(self):
        train_dataset = get_dataset(tokenizer=self.tokenizer, type_path="so_train", args=self.hparams)
    ...
    def val_dataloader(self):
        val_dataset = get_dataset(tokenizer=self.tokenizer, type_path="so_val", args=self.hparams)
...
train_path = "paraphrase_data/so_train.csv"
val_path = "paraphrase_data/so_val.csv"
...
args_dict.update({'data_dir': 'paraphrase_data', 'output_dir': 't5_paraphrase', 'num_train_epochs':4,'max_seq_length':256})
